...
L.LayerGroup.include({
	...
	_snakingLayers: [],		//this is a list of layers to be added to and removed from the group
	_snakingLayersDone: 0,	//this is the number of layers completed
	_activeTimeout: 0,		//this is a reference to the currently active timeout (for pauses between groups)
	...
	snakeIn: function() {
		...
		//remove all of the layers from the group
		this.clearLayers();
	...
	snakeSkipBack: function() {
		...
		this.removeLayer(groupLayers[groupLayers.length-1]);
